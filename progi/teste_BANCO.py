...
def update_product_interface():
    ...
    if code and description and price:
        try:
            update_product(code, description, float(price))
...
tk.Label(root, text="Código:").grid(row=0, column=0, padx=10, pady=10)
code_entry = tk.Entry(root)
code_entry.grid(row=0, column=1, padx=10, pady=10)

tk.Label(root, text="Descrição:").grid(row=1, column=0, padx=10, pady=10)
